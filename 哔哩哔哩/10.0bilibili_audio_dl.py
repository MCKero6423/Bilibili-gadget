...
def show_menu() -> str:
    ...
    print("9. 查看IP地理位置")
    print("10. 直播")
    print("11. 弹幕点赞")  # 新增弹幕点赞选项
    print("12. 退出程序")  # 原来的退出选项序号改为12
    print("="*50)
    
    choice = input("请选择功能 (1-12) [1]: ").strip()
    if not choice:
        return '1'
        ...
        if choice == '1':
            ...
            while True:
                ...
                if live_choice == '1':
                    ...
                    uid_input = input("请输入用户UID或���人空间链接: ").strip()
    ...
    try:
        ...
        if resp.status_code == 200:
            ...
            for elem in danmaku_seg.elems:
                ...
                if choice == 'y':
                    like_danmaku(str(elem.id), cid, cookies)  # 需要传入cookies参数
            ...
            print(f"获取弹幕失败: HTTP {resp.status_code}")  # 修复这行
    ...
    try:
        ...
        if data['code'] == 0:
            ...
            if anchor_data['room_news']['content']:
                print("\n主播公告:")
                print(f"内��: {anchor_data['room_news']['content']}")
